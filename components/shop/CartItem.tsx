    ...
    return (
        <li className='flex flex-row justify-between rounded-md bg-slate-200 font-caveat'>
            ...
            <div className='flex flex-col justify-center'>
                <button className='bg-pink-200 rounded-tr-md px-3 py-2 h-1/2' onClick={() => addItem}>-</button>
                <button className='bg-emerald-200 rounded-br-md px-3 py-2 h-1/2' onClick={() => removeItem}>+</button>
            </div>
        </li>
    );
};
